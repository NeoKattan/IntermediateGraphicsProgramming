...
namespace ew {
	...
	void createCube(float width, float height, float depth, MeshData& meshData)
	{
		...
		Vertex vertices[24] = {
			...
			//Back face
			{glm::vec3(+halfWidth, -halfHeight, -halfDepth), glm::vec3(0,0,-1), glm::vec2(1,0), glm::vec3(1,0,0)}, //BL
			{glm::vec3(-halfWidth, -halfHeight, -halfDepth), glm::vec3(0,0,-1), glm::vec2(0,0), glm::vec3(1,0,0)}, //BR
			{glm::vec3(-halfWidth, +halfHeight, -halfDepth), glm::vec3(0,0,-1), glm::vec2(0,1), glm::vec3(1,0,0)}, //TR
			{glm::vec3(+halfWidth, +halfHeight, -halfDepth), glm::vec3(0,0,-1), glm::vec2(1,1), glm::vec3(1,0,0)}, //TL

			//Right face
			{glm::vec3(+halfWidth, -halfHeight, +halfDepth), glm::vec3(1,0,0), glm::vec2(0,1), glm::vec3(0,0,1)}, //BL
			{glm::vec3(+halfWidth, -halfHeight, -halfDepth), glm::vec3(1,0,0), glm::vec2(0,0), glm::vec3(0,0,1)}, //BR
			{glm::vec3(+halfWidth, +halfHeight, -halfDepth), glm::vec3(1,0,0), glm::vec2(1,0), glm::vec3(0,0,1)}, //TR
			{glm::vec3(+halfWidth, +halfHeight, +halfDepth), glm::vec3(1,0,0), glm::vec2(1,1), glm::vec3(0,0,1)}, //TL

			//Left face
			{glm::vec3(-halfWidth, -halfHeight, -halfDepth), glm::vec3(-1,0,0), glm::vec2(0,0), glm::vec3(0,0,-1)}, //BL
			{glm::vec3(-halfWidth, -halfHeight, +halfDepth), glm::vec3(-1,0,0), glm::vec2(0,1), glm::vec3(0,0,-1)}, //BR
			{glm::vec3(-halfWidth, +halfHeight, +halfDepth), glm::vec3(-1,0,0), glm::vec2(1,1), glm::vec3(0,0,-1)}, //TR
			{glm::vec3(-halfWidth, +halfHeight, -halfDepth), glm::vec3(-1,0,0), glm::vec2(1,0), glm::vec3(0,0,-1)}, //TL

			//Top face
			{glm::vec3(-halfWidth, +halfHeight, +halfDepth), glm::vec3(0,1,0), glm::vec2(0,1), glm::vec3(1,0,0)}, //BL
			{glm::vec3(+halfWidth, +halfHeight, +halfDepth), glm::vec3(0,1,0), glm::vec2(1,1), glm::vec3(1,0,0)}, //BR
			{glm::vec3(+halfWidth, +halfHeight, -halfDepth), glm::vec3(0,1,0), glm::vec2(1,0), glm::vec3(1,0,0)}, //TR
			{glm::vec3(-halfWidth, +halfHeight, -halfDepth), glm::vec3(0,1,0), glm::vec2(0,0), glm::vec3(1,0,0)}, //TL
	...
	void createSphere(float radius, int numSegments, MeshData& meshData)
	{
		...
		meshData.vertices.push_back({ glm::vec3(0,topY,0),glm::vec3(0,1,0), glm::vec2(1,1), glm::vec3(1, 0, 0)});
		...
		for (int i = 1; i < numSegments; i++)
		{
			...
			for (int j = 0; j <= numSegments; ++j)
			{
				...
				glm::vec2 uv = glm::vec2(atanf(z/x) / (2*3.14159), acosf(y) / 3.14159);
		...
		meshData.vertices.push_back({ glm::vec3(0,bottomY,0), glm::vec3(0,-1,0), glm::vec2(0,0), glm::vec3(1, 0, 0)});
	...
	void createCylinder(float height, float radius, int numSegments, MeshData& meshData)
	{
		...
		//VERTICES
		//Top cap (facing up)
		meshData.vertices.push_back(Vertex(glm::vec3(0, halfHeight, 0), glm::vec3(0, 1, 0), glm::vec2(1, 1), glm::vec3(1, 0, 0)));
		for (int i = 0; i <= numSegments; i++)
		{
			...
			float u = (cosf(i * thetaStep) + 1) / 2;
			float v = (sinf(i * thetaStep) + 1) / 2;
			meshData.vertices.push_back(Vertex(pos, glm::vec3(0, 1, 0), glm::vec2(pos.x / radius, pos.z / radius), glm::vec3(1, 0, 0)));
		}
		...
		for (int i = 0; i <= numSegments; i++)
		{
			...
			float u = ((cosf(i * thetaStep)) + 1) / 2;
			float v = ((sinf(i * thetaStep)) + 1) / 2;
			meshData.vertices.push_back(Vertex(pos, glm::vec3(0, -1, 0), glm::vec2(u, v), glm::vec3(1, 0, 0)));
		}
		...
		for (int i = 0; i <= numSegments; i++)
		{
			...
			float u = atanf(pos.z / pos.x) / (2 * 3.14159);
			glm::vec2 uv = glm::vec2(u, pos.y);
			meshData.vertices.push_back(Vertex(pos, normal, uv, glm::vec3(normal.z, normal.y, -normal.x)));
		}
		//Side bottom ring
		for (int i = 0; i <= numSegments; i++)
		{
